...
import {IconButton, InputAdornment, TextField, makeStyles, useTheme} from "@material-ui/core";
import {Add as DefaultIncreaseIcon, Remove as DefaultDecreaseIcon} from "@material-ui/icons";
...
const useStyles = makeStyles(theme => ({
    ...
    root: {
        width: props => props.fullWidth ? null : (typeof props.max !== "number" && typeof props.max !== "string") ? "calc(4ch + 125px)" : `calc(${props.max.toString().length}ch + 180px)`,
                ...
                endAdornment: (
                    <InputAdornment position="end">
                        <IconButton
                            ...
                            className={[classes.incrementButton, classes.increaseButton, classes.largeSvgIcon].join(" ")}
                            color="secondary"
                ...
                startAdornment: (
                    <InputAdornment position="start">
                        <IconButton
                            ...
                            className={[classes.incrementButton, classes.decreaseButton, classes.largeSvgIcon].join(" ")}
                            color="secondary"
